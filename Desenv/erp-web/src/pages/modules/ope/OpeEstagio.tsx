...
const OpeEstagio: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_estagio",
        appHeader: capitalize(t("IN18ESTAGIOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opeestagioform"
        appServiceDefault={opeEstagioService}
        appDataTableColumns={dataTableColumns}
        appProgramId={ConstProgramUtil.cOpeestagioId}
