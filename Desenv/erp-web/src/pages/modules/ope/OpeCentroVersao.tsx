...
const OpeCentroVersao: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_versao",
        appHeader: capitalize(t("IN18VERSAODECENTROSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "versao_atual_obj.description",
        appHeader: capitalize(t("IN18VERSAOATUALDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "data_per_ini",
        appHeader: capitalize(t("IN18DATAPERIODOINICIALDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "data_per_fin",
        appHeader: capitalize(t("IN18DATAPERIODOFINALDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "tipo_per_obj.description",
        appHeader: capitalize(t("IN18TIPOPERIODODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opecentroversaoform"
        appDataTableColumns={dataTableColumns}
        appProgramId={ConstProgramUtil.cOpecentroversaoId}
...
export default OpeCentroVersao;
