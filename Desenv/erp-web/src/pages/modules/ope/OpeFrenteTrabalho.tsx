...
const OpeFrenteTrabalho: React.FC = () => {
  // ==============================
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_frente_trabalho",
        appHeader: capitalize(t("IN18FRENTEDETRABALHOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
...
export default OpeFrenteTrabalho;
