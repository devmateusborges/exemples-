...
const OpeCicloVar: React.FC = () => {
  ...
  return (
    <>
      <GenericListPage
        id="opeciclovar"
        appTitle={capitalize(t("IN18OPECICLODAVARIEDADEDEFAULT"))}
        appRouteForm="/private/ope/opeciclovarform"
        appDataTableColumns={dataTableColumns}
        appServiceDefault={opeCicloVarService}
        appProgramId={ConstProgramUtil.cOpeciclovarId}
