...
const OpeOcorStatus: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_ocor_status",
        appHeader: capitalize(t("IN18STATUSDAOCORRENCIASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opeocorstatusform"
        appDataTableColumns={dataTableColumns}
        appServiceDefault={opeOcorStatusService}
        appProgramId={ConstProgramUtil.cOpeocorstatusId}
