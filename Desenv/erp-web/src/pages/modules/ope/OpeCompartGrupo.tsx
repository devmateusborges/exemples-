...
const OpeCompartGrupo: React.FC = () => {
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opecompartgrupoform"
        appDataTableColumns={dataTableColumns}
        appServiceDefault={opeCompartGrupoService}
        appProgramId={ConstProgramUtil.cOpecompartgrupoId}
...
export default OpeCompartGrupo;
