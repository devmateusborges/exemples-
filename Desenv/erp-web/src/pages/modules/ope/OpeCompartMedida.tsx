...
const OpeCompartMedida: React.FC = () => {
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opecompartmedidaform"
        appProgramId={ConstProgramUtil.cOpecompartmedidaId}
...
export default OpeCompartMedida;
