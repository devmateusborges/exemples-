...
const OpeOcorGrupo: React.FC = () => {
  ...
  return (
    <>
      <GenericListPage
        id="opeocorgrupo"
        appTitle={capitalize(t("IN18OPEGRUPODEOCORRENCIADEFAULT"))}
        appRouteForm="/private/ope/opeocorgrupoform"
        appServiceDefault={opeOcorGrupoService}
        appDataTableColumns={dataTableColumns}
        appProgramId={ConstProgramUtil.cOpeocorgrupoId}
