...
const OpeCompartStatusForm: React.FC = () => {
  // ==============================
  ...
  const fieldControls: Array<IFieldControl> = [
    {
      fieldName: "sigla_compart_status",
  ...
  return (
    <>
      <GenericFormPage
        ...
        appRouteList="/private/ope/opecompartstatus"
        appShowTopBar
      >
        <TabView
        ...
        >
          <TabPanel header="General ">
            <AppContainerFields>
              <AppFieldText
                appFormControl={formControl}
                name="sigla_compart_status"
                appTitle={capitalize(
                  t("IN18STATUSDECOMPARTIMENTOSIGLADEFAULT")
                )}
...
export default OpeCompartStatusForm;
