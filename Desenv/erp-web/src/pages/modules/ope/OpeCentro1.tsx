...
import OpeCentro1Service from "../../../services/modules/ope/OpeCentro1Service";
import { IAppDataTableColumns } from "../../../components/toolkit-react/AppDataTable";
import GenericListPage from "../../generics/GenericListPage";

const opeCentro1Service = new OpeCentro1Service();

const OpeCentro1: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "ope_centro_subtipo_id_obj.sigla_centro_subtipo",
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18CENTROSUBTIPONOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        appTitle={capitalize(t("IN18OPECENTRO1DEFAULT"))}
        appShowTopBar
        appRouteForm="/private/ope/opecentro1form"
        ...
        appEditVisible
        appAddVisible
        appServiceDefault={opeCentro1Service}
      />
    </>
  );
};

export default OpeCentro1;
