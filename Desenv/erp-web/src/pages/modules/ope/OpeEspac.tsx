...
import OpeEspacService from "../../../services/modules/ope/OpeEspacService";
import { apiParamsConvert } from "../../../utils/ApiUtil";
import { IAppDataTableColumns } from "../../../components/toolkit-react/AppDataTable";
import GenericListPage from "../../generics/GenericListPage";
import { ConstProgramUtil } from "../../../utils/ConstProgramUtil";

const opeEspacService = new OpeEspacService();

const OpeEspac: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_espac",
        appHeader: capitalize(t("IN18ESPACAMENTOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        id="opeespac"
        appTitle={capitalize(t("IN18OPEESPACAMENTODEFAULT"))}
        appRouteForm="/private/ope/opeespacform"
        appServiceDefault={opeEspacService}
        appDataTableColumns={dataTableColumns}
        appProgramId={ConstProgramUtil.cOpeespacId}
