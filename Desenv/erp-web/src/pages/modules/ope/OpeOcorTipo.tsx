...
const OpeOcorTipo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_ocor_tipo",
        appHeader: capitalize(t("IN18TIPODEOCORRENCIASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "obrig_ope_compart_obj.description",
        appHeader: capitalize(t("IN18OBRIGACOMPARTIMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ope/opeocortipoform"
        appDataTableColumns={dataTableColumns}
        appServiceDefault={opeOcorTipoService}
        appProgramId={ConstProgramUtil.cOpeocortipoId}
