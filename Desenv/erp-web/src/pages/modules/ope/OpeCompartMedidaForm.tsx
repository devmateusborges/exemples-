...
const OpeCompartMedidaForm: React.FC = () => {
  // ==============================
  ...
  const fieldControls: Array<IFieldControl> = [
    {
      fieldName: "sigla_compart_medida",
  ...
  return (
    <>
      <GenericFormPage
        ...
        appTitle={capitalize(t("IN18OPECOMPARTIMENTOMEDIDADEFAULT"))}
        appRouteList="/private/ope/opecompartmedida"
        appShowTopBar
      >
        <TabView
...
export default OpeCompartMedidaForm;
