...
const OpeAtividadeGrupo: React.FC = () => {
  // ==============================
  ...
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_atividade_grupo",
  ...
  return (
    <>
      <GenericListPage
        id="opeatividadegrupo"
        appTitle={capitalize(t("IN18OPEGRUPODEATIVIDADEDEFAULT"))}
        appRouteForm="/private/ope/opeatividadegrupoform"
        appDataTableDataKey="id"
        appDataTableColumns={dataTableColumns}
        appProgramId={ConstProgramUtil.cOpeatividadegrupoId}
...
export default OpeAtividadeGrupo;
