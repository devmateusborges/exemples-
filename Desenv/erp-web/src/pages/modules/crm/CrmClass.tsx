...
const CrmClass: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "crm_class_subgrupo_id_obj.sigla_class_subgrupo",
        appHeader: capitalize(t("IN18CLASSESUBGRUPODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "crm_class_subgrupo_id_obj.nome",
        appHeader: capitalize(t("IN18CLASSEGRUPONOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/crm/crmclassform"
        ...
        appProgramId={ConstProgramUtil.cCrmclassId}
