...
const CrmChatGrupo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_chat_grupo",
        appHeader: capitalize(t("IN18CHATGRUPOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "acesso_privado_obj.description",
        appHeader: capitalize(t("IN18ACESSOPRIVADODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_user_id_dest_obj.login",
        appHeader: capitalize(t("IN18USUARIODESTINOLOGINDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_user_id_dest_obj.name",
        appHeader: capitalize(t("IN18USUARIODESTINONOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_user_id_orig_obj.login",
        appHeader: capitalize(t("IN18USUARIOORIGEMLOGINDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_user_id_orig_obj.name",
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/crm/crmchatgrupoform"
        ...
        appProgramId={ConstProgramUtil.cCrmchatgrupoId}
