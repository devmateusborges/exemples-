...
import CrmEtapaService from "../../../services/modules/crm/CrmEtapaService";
...
const crmEtapaService = new CrmEtapaService();

const CrmEtapa: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_etapa",
        appHeader: capitalize(t("IN18ETAPASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        id="crmetapa"
        appTitle={capitalize(t("IN18CRMETAPASDEFAULT"))}
        appShowTopBar
        appRouteForm="/private/crm/crmetapaform"
        ...
        appEditVisible
        appAddVisible
        appServiceDefault={crmEtapaService}
        appProgramId={ConstProgramUtil.cCrmetapaId}
