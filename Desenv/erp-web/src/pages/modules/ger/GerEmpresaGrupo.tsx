...
const GerEmpresaGrupo: React.FC = () => {
  // ==============================
  ...
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_ger_empresa_grupo",
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ger/gerempresagrupoform"
        appProgramId={ConstProgramUtil.cGerempresagrupoId}
...
export default GerEmpresaGrupo;
