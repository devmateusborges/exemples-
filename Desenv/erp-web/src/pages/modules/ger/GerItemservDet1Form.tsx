...
export const dataTableColumnsDet1: IAppDataTableColumns = {
  columns: [
    ...
    {
      appField: "codigo_barra",
      appHeader: capitalize(t("IN18CODIGODEBARRADEFAULT")),
      appSortable: true,
      appFilter: true,
      appFilterMatch: "contains",
      appFilterGlobal: true,
  ...
  const fieldControls: Array<IFieldControl> = [
    {
      ...
      required: [true, "Código de barra is required"],
      maxValue: [100, "Maximum 100 characters for Código de barra"],
      defaultValue: "",
      type: "text",
    },
    {
        ...
        <div className="p-0 md:p-2">
          <AppContainerFields>
            <AppFieldText
              appFormControl={formControl}
              name="codigo_barra"
              appTitle={capitalize(t("IN18CODIGODEBARRADEFAULT"))}
              appHelpText="Código de barra Help"
            />
