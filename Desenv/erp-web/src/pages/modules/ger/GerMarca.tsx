...
import { dataTableColumnsDet1 } from "./GerMarcaDet1Form";
import { dataTableColumnsDet2 } from "./GerMarcaDet2Form";

const gerMarcaService = new GerMarcaService();

const GerMarca: React.FC = () => {
  // ==============================
  ...
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_ger_marca",
        appHeader: capitalize(t("IN18MARCASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/ger/germarcaform"
