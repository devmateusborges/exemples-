...
const FisDocTipoForm: React.FC = () => {
  ...
  const fieldControls: Array<IFieldControl> = [
    {
      fieldName: "sigla_fis_doc_tipo",
      required: [true, "Tipo  Documento - sigla is required"],
      defaultValue: "",
      type: "text",
  ...
  return (
    <>
      <GenericFormPage
        ...
        appRouteList="/private/fis/fisdoctipo"
        appShowTopBar
      >
        <TabView
        ...
        >
          <TabPanel header="General">
            <AppContainerFields>
              <AppFieldText
                appFormControl={formControl}
                name="sigla_fis_doc_tipo"
                appTitle={capitalize(t("IN18TIPODOCUMENTOSIGLADEFAULT"))}
                appHelpText="Tipo  Documento - sigla Help"
              />
              <AppFieldText
                appFormControl={formControl}
                name="nome"
              ...
              <AppFieldText
                appFormControl={formControl}
                name="modelo"
                appTitle={capitalize(t("IN18MODELODEFAULT"))}
                appHelpText="Modelo Help"
              />
              <AppFieldCheck
                appFormControl={formControl}
                name="ativo"
