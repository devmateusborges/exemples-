...
const FisDocTipo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_fis_doc_tipo",
        appHeader: capitalize(t("IN18TIPODOCUMENTOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "modelo",
        appHeader: capitalize(t("IN18MODELODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fis/fisdoctipoform"
        ...
        appProgramId={ConstProgramUtil.cFisdoctipoId}
