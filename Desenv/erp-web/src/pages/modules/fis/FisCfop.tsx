...
const FisCfop: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "nr_cfop",
        appHeader: capitalize(t("IN18NUMEROCFOPDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fis/fiscfopform"
        ...
        appProgramId={ConstProgramUtil.cFiscfopId}
