...
const FisNcm: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "nr_ncm",
        appHeader: capitalize(t("IN18NUMERONCMDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appProgramId={ConstProgramUtil.cFisncmId}
        appPreferenceVisible
        appFavoriteVisible
        appShowTopBar
        appRouteForm="/private/fis/fisncmform"
