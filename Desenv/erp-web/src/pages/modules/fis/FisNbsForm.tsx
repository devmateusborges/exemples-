...
const FisNbsForm: React.FC = () => {
  ...
  const fieldControls: Array<IFieldControl> = [
    ...
    {
      fieldName: "nr_nbs",
      required: [true, "Numero B=NBS is required"],
      defaultValue: "",
      type: "text",
      maxValue: [100, "Maximum 100 for valor"],
    },
  ...
  return (
    <>
      <GenericFormPage
        ...
        appRouteList="/private/fis/fisnbs"
        appShowTopBar
      >
        <TabView
          ...
          <TabPanel header="General ">
            <AppContainerFields>
              ...
              <AppFieldText
                appFormControl={formControl}
                name="nr_nbs"
                appHelpText="Numero NBS help"
                appTitle={capitalize(t("IN18NUMERONBSDEFAULT"))}
              />
              <AppFieldDate
                appFormControl={formControl}
                name="data_validade"
