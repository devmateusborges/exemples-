...
const FinBanco: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "nr_banco",
        appHeader: capitalize(t("IN18NUMERODOBANCODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        id="finbanco"
        appTitle={capitalize(t("IN18FINBANCODEFAULT"))}
        appShowTopBar
        appRouteForm="/private/fin/finbancoform"
        ...
        appProgramId={ConstProgramUtil.cFinbancoId}
