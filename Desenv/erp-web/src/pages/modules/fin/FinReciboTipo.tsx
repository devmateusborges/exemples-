...
const FinReciboTipo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_fin_recibo_tipo",
        appHeader: capitalize(t("IN18TIPODERECIBOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18VALORPADRAODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/finrecibotipoform"
        ...
        appProgramId={ConstProgramUtil.cFinrecibotipoId}
