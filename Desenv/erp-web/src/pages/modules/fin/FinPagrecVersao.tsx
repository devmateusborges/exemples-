...
const FinPagrecVersao: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18VERSAOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/finpagrecversaoform"
        ...
        appProgramId={ConstProgramUtil.cFinpagrecversaoId}
...
export default FinPagrecVersao;
