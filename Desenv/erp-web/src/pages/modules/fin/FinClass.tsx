...
const FinClass: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_class",
        appHeader: capitalize(t("IN18CLASSESIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18TIPOENTRADA/SAIDADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "tipo_fluxo_obj.description",
        appHeader: capitalize(t("IN18CONSIDERADOPAG/RECDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "fixo_variavel_obj.description",
        appHeader: capitalize(t("IN18FIXOVARIAVELDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "tipo_prev_obj.description",
        appHeader: capitalize(t("IN18TIPOPREVISAODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/finclassform"
        ...
        appProgramId={ConstProgramUtil.cFinclassId}
