...
const FinLote: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "data_lote",
        appHeader: capitalize(t("IN18DATALOTEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/finloteform"
        ...
        appProgramId={ConstProgramUtil.cFinloteId}
