  ...
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18GRUPODECLASSESIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/finclassgrupoform"
        ...
        appProgramId={ConstProgramUtil.cFinclassgrupoId}
