...
const FinDocTipo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_fin_doc_tipo",
        appHeader: capitalize(t("IN18TIPODEDOCUMENTOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/findoctipoform"
        ...
        appProgramId={ConstProgramUtil.cFindoctipoId}
