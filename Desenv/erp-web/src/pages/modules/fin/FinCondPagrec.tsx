...
const FinCondPagrec: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_cond_pagamento",
        appHeader: capitalize(t("IN18CONDICAODEPAGAMENTOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "qnt_dia_ini",
        appHeader: capitalize(t("IN18QUANTIDADEDIASINICIALDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "considera_feriado_obj.description",
        appHeader: capitalize(t("IN18CONSIDERAFERIADODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "considera_final_sem_obj.description",
        appHeader: capitalize(t("IN18CONSIDERAFINALDESEMANADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "tipo_prazo_obj.description",
        appHeader: capitalize(t("IN18TIPOPRAZODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/fincondpagrecform"
        ...
        appProgramId={ConstProgramUtil.cFincondpagrecId}
