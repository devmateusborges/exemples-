...
const FinConta: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "nr_agencia",
        appHeader: capitalize(t("IN18NUMEROAGENCIADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/fincontaform"
        ...
        appProgramId={ConstProgramUtil.cFincontaId}
