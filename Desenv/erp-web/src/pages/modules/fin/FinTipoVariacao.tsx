...
const FinTipoVariacao: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_fin_tipo_variacao",
        appHeader: capitalize(t("IN18TIPOVARIACAOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "valor_positivo_obj.description",
        appHeader: capitalize(t("IN18VALORPOSITIVODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/fin/fintipovariacaoform"
        ...
        appProgramId={ConstProgramUtil.cFintipovariacaoId}
...
export default FinTipoVariacao;
