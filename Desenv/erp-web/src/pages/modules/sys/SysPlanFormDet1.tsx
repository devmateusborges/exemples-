...
interface IASysPlanDet1Form extends IAppDet {}
...
// ==============================
const sysPlanDet1Form: React.FC<IASysPlanDet1Form> = (
  props: IASysPlanDet1Form
) => {
  // ==============================
  ...
  return (
    <>
      <GenericFormDet
        ref={props.appRef}
        name="sys_plan_restriction_childs"
        appGenericListOptions={{
          id: "sysplanrestrictiondet1",
          appHelpText: "sistema plano Help",
          appDataTableColumns: dataTableColumnsDet1,
          appProgramId: ConstProgramUtil.cSysplanId,
...
export default memo(sysPlanDet1Form);
