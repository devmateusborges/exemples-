...
import { dataTableColumnsDet1 } from "./SysLicenceFormDet1";

const sysLicenceService = new SysLicenceService();

const SysLicence: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "code_licence",
        appHeader: capitalize(t("IN18LICENCASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "nome_solicitante",
        appHeader: capitalize(t("IN18SOLICITANTENOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "tipo_doc",
        appHeader: capitalize(t("IN18TIPODOCUMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "doc",
        appHeader: capitalize(t("IN18DOCUMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "end_bairro",
        appHeader: capitalize(t("IN18ENDERECOBAIRRODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "end_cidade",
        appHeader: capitalize(t("IN18ENDERECOCIDADEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "end_uf",
        appHeader: capitalize(t("IN18ENDERECOUNIDADEFEDERACAODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "end_pais",
        appHeader: capitalize(t("IN18ENDERECOPAISDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "chamado_id",
        appHeader: capitalize(t("IN18CHAMADOIDENTIFICADORDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "status_data",
        appHeader: capitalize(t("IN18DATADOSTATUSDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      },
      {
        ...
        appHeader: capitalize(t("IN18STATUSOBSERVACAODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_version",
        appHeader: capitalize(t("IN18VERSAODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_plan_id_obj.code_plan",
        appHeader: capitalize(t("IN18PLANOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_plan_id_obj.name",
        appHeader: capitalize(t("IN18PLANONOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_id_obj.code_sys",
        appHeader: capitalize(t("IN18SISTEMASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_id_obj.name",
        appHeader: capitalize(t("IN18SISTEMANOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appRouteForm="/private/sys/syslicenceform"
