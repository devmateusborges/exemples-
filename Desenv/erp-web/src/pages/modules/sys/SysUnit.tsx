...
const SysUnit: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "code_unit",
        appHeader: capitalize(t("IN18SISTEMAUNIDADESIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "sys_unit_manager_id_obj.name",
        appHeader: capitalize(t("IN18GESTORADEUNIDADENOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/sys/sysunitform"
        ...
        appProgramId={ConstProgramUtil.cSysunitId}
