...
const SysRestriction: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "code_restriction",
        appHeader: capitalize(t("IN18RESTRICAOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "type_value_obj.description",
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/sys/sysrestrictionform"
        ...
        appProgramId={ConstProgramUtil.cSysrestrictionId}
