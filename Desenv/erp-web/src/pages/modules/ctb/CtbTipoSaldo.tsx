...
const CtbTipoSaldo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_tipo_saldo",
        appHeader: capitalize(t("IN18TIPOSALDOSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "mes_ini_fechamento",
        appHeader: capitalize(t("IN18MESINICIALDEFECHAMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "mes_fin_fechamento",
        appHeader: capitalize(t("IN18MESFINALDEFECHAMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/ctb/ctbtiposaldoform"
        ...
        appProgramId={ConstProgramUtil.cCtbtiposaldoId}
