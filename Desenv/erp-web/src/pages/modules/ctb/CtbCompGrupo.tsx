...
const CtbCompGrupo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_comp_grupo",
        appHeader: capitalize(t("IN18GRUPODECOMPONENTESIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        appTitle={capitalize(t("IN18CTBGRUPODECOMPONENTEDEFAULT"))}
        appShowTopBar
        appRouteForm="/private/ctb/ctbcompgrupoform"
        ...
        appProgramId={ConstProgramUtil.cCtbcompgrupoId}
