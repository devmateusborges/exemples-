...
const CtbCentroGrupoForm: React.FC = () => {
  // ==============================
  ...
  const fieldControls: Array<IFieldControl> = [
    {
      ...
      required: [true, "Centro Grupo - Sigla is required"],
      defaultValue: "",
      type: "text",
  ...
  return (
    <>
      <GenericFormPage
        ...
        appTitle={capitalize(t("IN18CTBGRUPODECENTRODEFAULT"))}
        appRouteList="/private/ctb/ctbcentrogrupo"
        appShowTopBar
      >
        <TabView
          ...
          <TabPanel header="General">
            <AppContainerFields>
              <AppFieldText
                ...
                appTitle={capitalize(t("IN18CENTROGRUPOSIGLADEFAULT"))}
                appHelpText="Centro Grupo - Sigla Help"
              />
              <AppFieldText
                appFormControl={formControl}
                name="nome"
...
export default CtbCentroGrupoForm;
