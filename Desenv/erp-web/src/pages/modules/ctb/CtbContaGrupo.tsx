...
const CtbContaGrupo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "sigla_conta_grupo",
        appHeader: capitalize(t("IN18GRUPODECONTASIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "estrutura",
        appHeader: capitalize(t("IN18ESTRUTURADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "ctb_conta_versao_id_obj.sigla_versao",
        appHeader: capitalize(t("IN18VERSAOCONTACONTABILSIGLADEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
      ...
      {
        appField: "ctb_conta_versao_id_obj.nome",
        appHeader: capitalize(t("IN18VERSAOCONTACONTABILNOMEDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/ctb/ctbcontagrupoform"
        ...
        appProgramId={ConstProgramUtil.cCtbcontagrupoId}
