...
const CtbVersao: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "tipo_rp_obj.description",
        appHeader: capitalize(t("IN18TIPORPDEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/ctb/ctbversaoform"
        ...
        appProgramId={ConstProgramUtil.cCtbversaoId}
