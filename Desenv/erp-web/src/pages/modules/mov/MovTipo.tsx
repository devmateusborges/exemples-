...
const MovTipo: React.FC = () => {
  const dataTableColumns: IAppDataTableColumns = {
    columns: [
      ...
      {
        appField: "tipo_mov",
        appHeader: capitalize(t("IN18TIPODOMOVIMENTODEFAULT")),
        appSortable: true,
        appFilter: true,
        appFilterMatch: "contains",
        appFilterGlobal: true,
  ...
  return (
    <>
      <GenericListPage
        ...
        appShowTopBar
        appRouteForm="/private/mov/movtipoform"
        ...
        appProgramId={ConstProgramUtil.cMovtipoId}
