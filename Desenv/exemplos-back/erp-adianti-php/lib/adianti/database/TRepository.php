...
class TRepository
{
    ...
    {
        //EJ Alteração
        return constant($this->class.'::PRIMARYKEY');
    }
    
    /**
     * Returns the the name of the Unit Field for that Repository
    ...
    public function getUnitField()
    {
        ...
        //EJ Aletrações
        if (defined($this->class.'::UNITFIELD')) {
          return constant($this->class.'::UNITFIELD');
        } else
        {
          return '';
        }
