...
class SystemMessage extends TRecord
{
    ...
    {
        return SystemUser::findInTransaction(TSession::getValue('pConn'), $this->system_user_id);
    }
    
    public function get_user_to()
    {
        return SystemUser::findInTransaction(TSession::getValue('pConn'), $this->system_user_to_id);
    }
