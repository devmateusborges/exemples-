...
class SystemUserForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $program_id          = new TDBSeekButton('program_id', TSession::getValue('pConn'), 'form_System_user', 'SystemProgram', 'name', 'program_id', 'program_name');
        $program_name        = new TEntry('program_name');
        $groups              = new TDBCheckGroup('groups',TSession::getValue('pConn'),'SystemGroup','id','name');
        $frontpage_id        = new TDBUniqueSearch('frontpage_id', TSession::getValue('pConn'), 'SystemProgram', 'id', 'name', 'name');
        $units               = new TDBCheckGroup('units',TSession::getValue('pConn'),'SystemUnit','id','name');
