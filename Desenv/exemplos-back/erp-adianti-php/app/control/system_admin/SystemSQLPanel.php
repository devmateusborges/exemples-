...
class SystemSQLPanel extends TPage
{
    ...
    public function __construct()
    {
        ...
        $btn = $this->form->addHeaderAction( _t('Generate'), new TAction(array($this, 'onGenerate')), 'fa:check-circle');
        $btn->class = 'btn btn-sm btn-primary';
        
        $this->form->addHeaderAction( 'CSV', new TAction(array($this, 'onExportCSV')), 'fa:table');
