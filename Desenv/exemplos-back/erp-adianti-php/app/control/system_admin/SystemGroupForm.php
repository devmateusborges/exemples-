...
class SystemGroupForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $name->id = 'edname';
        $program_id = new TDBSeekButton('program_id', TSession::getValue('pConn'), 'form_System_group', 'SystemProgram', 'name', 'program_id', 'program_name');
        ...
        $this->BtnTour = $this->form->addHeaderAction('Help', new TAction(array('SystemGroupForm', 'onNone')), 'fa:question-circle');
        $this->BtnTour->class = 'btn btn-sm bg-pink';
        $this->BtnTour->addFunction("SystemGroupFormTour()");
