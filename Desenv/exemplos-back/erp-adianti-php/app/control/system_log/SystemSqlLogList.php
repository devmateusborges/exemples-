...
class SystemSqlLogList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setLimit(20);
        //Filtro unit_id do login (OBRIGATORIO)
        ...
        $database = $this->datagrid->addQuickColumn(_t('Database'), 'database_name', 'left', NULL, new TAction(array($this, 'onReload')), array('order', 'database_name'));
        $unit_id = $this->datagrid->addQuickColumn('Unit', 'unit_id', 'left', NULL);
