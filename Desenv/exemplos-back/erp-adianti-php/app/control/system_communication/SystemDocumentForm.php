...
class SystemDocumentForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $category_id = new TDBCombo('category_id', TSession::getValue('pConn'), 'SystemDocumentCategory', 'id', 'name');
        $submission_date = new TDate('submission_date');
        $archive_date = new TDate('archive_date');
        $user_ids = new TDBMultiSearch('user_ids', TSession::getValue('pConn'), 'SystemUser', 'id', 'name');
        $group_ids = new TDBCheckGroup('group_ids', TSession::getValue('pConn'), 'SystemGroup', 'id', 'name');
