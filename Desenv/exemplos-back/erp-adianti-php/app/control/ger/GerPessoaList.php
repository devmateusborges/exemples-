...
class GerPessoaList extends GenericStandartList
{

    const C_RECORD_CLASS   = 'GerPessoa';
...
"ColunaTransf":"TransfAtivo"
    ...
    const C_FORM_TITLE   = 'Listagem de Pessoa';
    const C_FORM_CLASS_EDIT   = 'GerPessoaForm';
