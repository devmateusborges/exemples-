...
@Entity
@Table(name="ind_vr_quinzena")
@NamedQuery(name="IndVrQuinzena.findAll", query="SELECT i FROM IndVrQuinzena i")
public class IndVrQuinzena implements Serializable {
