...
@Entity
@Table(name="ind_vr_trimestre")
@NamedQuery(name="IndVrTrimestre.findAll", query="SELECT i FROM IndVrTrimestre i")
public class IndVrTrimestre implements Serializable {
