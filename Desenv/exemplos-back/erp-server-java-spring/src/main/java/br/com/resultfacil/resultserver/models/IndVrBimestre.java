...
@Entity
@Table(name="ind_vr_bimestre")
@NamedQuery(name="IndVrBimestre.findAll", query="SELECT i FROM IndVrBimestre i")
public class IndVrBimestre implements Serializable {
