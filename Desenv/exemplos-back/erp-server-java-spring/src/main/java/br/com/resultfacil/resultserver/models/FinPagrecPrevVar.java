...
@Entity
@Table(name="fin_pagrec_prev_var")
@NamedQuery(name="FinPagrecPrevVar.findAll", query="SELECT f FROM FinPagrecPrevVar f")
public class FinPagrecPrevVar implements Serializable {
