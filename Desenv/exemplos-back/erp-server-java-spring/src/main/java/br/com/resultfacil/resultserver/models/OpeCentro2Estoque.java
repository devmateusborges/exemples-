...
@Entity
@Table(name="ope_centro2_estoque")
@NamedQuery(name="OpeCentro2Estoque.findAll", query="SELECT o FROM OpeCentro2Estoque o")
public class OpeCentro2Estoque implements Serializable {
