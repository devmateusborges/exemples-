...
@Entity
@Table(name="ind_vr_semestre")
@NamedQuery(name="IndVrSemestre.findAll", query="SELECT i FROM IndVrSemestre i")
public class IndVrSemestre implements Serializable {
