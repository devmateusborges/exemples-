...
@Entity
@Table(name="mov_condutor")
@NamedQuery(name="MovCondutor.findAll", query="SELECT m FROM MovCondutor m")
public class MovCondutor implements Serializable {
...
@Column(name="log_date_ins")
	...
	@ManyToOne
	@JoinColumn(name="ger_pessoa_id_condutor", nullable=false)
