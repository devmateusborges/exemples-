...
import SysUserRoute from '../routes/sysUser.route';
...
describe('Testing Users', () => {
  describe('[GET] /users', () => {
    it('response findAll users', async () => {
      const usersRoute = new SysUserRoute();
      const users = usersRoute.controller.service.users;
