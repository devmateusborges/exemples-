...
class PecSisbov extends TRecord
{
    const TABLENAME  = 'pec_sisbov';
    const PRIMARYKEY = 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('codigo_mae');
        parent::addAttribute('codigo_pai');
        parent::addAttribute('aptidao');
        parent::addAttribute('nirf_nascimento');
        parent::addAttribute('nirf_atual');
    ...
    public function getPecAnimals()
    {
        ...
        $criteria->add(new TFilter('pec_sisbov_id', '=', $this->id));
    ...
    public function get_pec_animal_system_unit_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('system_unit_id','{system_unit->name}');
    ...
    public function get_pec_animal_pec_raca_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_raca_id','{pec_raca->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_pelagem_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_pelagem_id','{pec_pelagem->id}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_categoria_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_categoria_id','{pec_categoria->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_brinco_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_brinco_id','{pec_brinco->codigo}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_sisbov_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_sisbov_id','{pec_sisbov->id}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_lote_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_lote_id','{pec_lote->descricao}');
        return implode(', ', $values);
    }
    ...
    public function get_pec_animal_pec_origem_to_string()
    {
        ...
        $values = PecAnimal::where('pec_sisbov_id', '=', $this->id)->getIndexedArray('pec_origem_id','{pec_origem->descricao}');
        return implode(', ', $values);
    }
