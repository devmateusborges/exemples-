...
class AdmCcustoHeaderList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'AdmCcusto';
    private static $primaryKey = 'id';
    private static $formName = 'formList_AdmCcusto';
    ...
    public function __construct($param = null)
    {
        ...
        $status->setExitAction(new TAction([$this, 'onSearch'], ['static'=>'1']));
        ...
        $column_status_transformed->setTransformer(function($value, $object, $row)
        {
        ...
        $action_onEdit = new TDataGridAction(array('AdmCcustoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('AdmCcustoHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Centro de Custo");
        ...
        $button_cadastrar->setAction(new TAction(['AdmCcustoForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['AdmCcustoHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:table #00b894' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['AdmCcustoHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['AdmCcustoHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Geral","Centro de Custo"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new AdmCcusto($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for AdmCcusto
