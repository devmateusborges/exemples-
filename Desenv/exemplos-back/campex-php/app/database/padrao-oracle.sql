...
CREATE TABLE pec_animal( 
      ...
      rgd varchar  (50)   , 
      dt_desmama date   , 
      vr_custo_entrada binary_double   , 
      vr_custo_kg binary_double   , 
      vr_custos_extra binary_double   , 
...
CREATE TABLE pec_especie( 
      ...
      descricao varchar  (100)   , 
      observacao varchar(3000)   , 
      tempo_gestacao number(10)   , 
      primeira_cobertura number(10)   , 
      diagnostico_apos_cobertura number(10)   , 
      proximo_cruzamento number(10)   , 
      tempo_lactacao number(10)   , 
      idade_desmama number(10)   , 
      nomenclatura_filhote number(10)   , 
 PRIMARY KEY (id)) ; 
...
CREATE TABLE pec_lote( 
      ...
      max_animais number(10)    NOT NULL , 
