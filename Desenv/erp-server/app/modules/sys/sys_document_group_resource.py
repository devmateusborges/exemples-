...
routes_sys_document_group = Blueprint(
    "sysdocumentgroup", __name__, url_prefix="/api/sys/sysdocumentgroup"
)
...
def find_all():
    return generic_resource.find_all(
        service=sys_document_group_service,
        model=SysDocumentGroup,
        schema=SysDocumentGroupSchema,
...
@routes_sys_document_group.route("/upload/<id>", methods=["POST"])
@jwt_required()
def post_file(id):
...
# ==============================
@routes_sys_document_group.route("/download/<id>", methods=["GET"])
...
# ==============================
@routes_sys_document_group.route("/downloadopen/<path:filename>", methods=["GET"])
