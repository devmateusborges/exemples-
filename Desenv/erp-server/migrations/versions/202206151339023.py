...
revision = '202206151339023'
down_revision = '202206151339022'
branch_labels = None
depends_on = None
...
alter table sys_migration add id varchar(36);

COMMENT ON COLUMN sys_migration.id IS 'ID de Dipositivos da Migrations';
