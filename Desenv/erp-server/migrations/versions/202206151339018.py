...
revision = '202206151339018'
down_revision = '202206151339017'
branch_labels = None
depends_on = None
...
CREATE OR REPLACE FUNCTION audit.audit_table(target_table regclass, audit_rows boolean, audit_query_text boolean,audit_query_smt boolean, ignored_cols text[]) RETURNS void AS $body$
DECLARE
...
CREATE OR REPLACE FUNCTION audit.audit_table(target_table regclass, audit_rows boolean, audit_query_text boolean,audit_query_smt boolean) RETURNS void AS $body$
