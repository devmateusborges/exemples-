...
revision = '202206151339006'
down_revision = '202206151339005'
branch_labels = None
depends_on = None
...
ALTER TABLE ger_itemserv_lote DROP COLUMN sigla_ger_marca_modelo;

ALTER TABLE ger_itemserv_lote RENAME COLUMN nome TO sigla_ger_itemserv_lote;
