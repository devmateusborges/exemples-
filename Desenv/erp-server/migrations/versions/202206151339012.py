...
revision = '202206151339012'
down_revision = '202206151339011'
branch_labels = None
depends_on = None
...
ADD log_user_upd VARCHAR(100);


comment on column crm_chat_msg.log_user_upd is 'Log - Usuário de Alteração';
--================================================================
