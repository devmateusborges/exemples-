...
revision = '202206151339020'
down_revision = '202206151339019'
branch_labels = None
depends_on = None
...
ALTER TABLE sys_access_log RENAME COLUMN system_user_id TO sys_user_id;

ALTER TABLE sys_access_log RENAME COLUMN system_id TO sys_id;
