...
@Entity
@Table(name="ger_marca_pessoa")
@NamedQuery(name="GerMarcaPessoa.findAll", query="SELECT g FROM GerMarcaPessoa g")
public class GerMarcaPessoa implements Serializable {
