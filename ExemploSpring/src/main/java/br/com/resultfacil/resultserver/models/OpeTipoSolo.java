...
@Entity
@Table(name="ope_tipo_solo")
@NamedQuery(name="OpeTipoSolo.findAll", query="SELECT o FROM OpeTipoSolo o")
public class OpeTipoSolo implements Serializable {
...
@Column(name="log_date_ins")
	...
	@Column(name="sigla_tipo_solo", length=50)
	private String siglaTipoSolo;

	//bi-directional many-to-one association to OpeCentro2Area
	@OneToMany(mappedBy="opeTipoSolo")
	...
	public String getSiglaTipoSolo() {
		return this.siglaTipoSolo;
	}

	public void setSiglaTipoSolo(String siglaTipoSolo) {
		this.siglaTipoSolo = siglaTipoSolo;
	}
	...
	public OpeCentro2Area addOpeCentro2Area(OpeCentro2Area opeCentro2Area) {
		...
		opeCentro2Area.setOpeTipoSolo(this);
	...
	public OpeCentro2Area removeOpeCentro2Area(OpeCentro2Area opeCentro2Area) {
		...
		opeCentro2Area.setOpeTipoSolo(null);
