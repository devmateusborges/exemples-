...
@Entity
@Table(name="ger_empresa_pessoa")
@NamedQuery(name="GerEmpresaPessoa.findAll", query="SELECT g FROM GerEmpresaPessoa g")
public class GerEmpresaPessoa implements Serializable {
